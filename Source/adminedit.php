...
<body>
	...
	<div class="login">
			...
			<tr> 
				...
				<td>
					<a class= " btn btn-primary" href="adminedit2.php?id=<?php echo $row['id'];?>"> edit</a>
					<a class= " btn btn-secondary"href="adminedit6.php?id=<?php echo $row['id'];?>"> hapus</a>
				</td>
			</tr>
			<?php 
					}
			...
			<a class= " btn btn-secondary" href="adminedit4.php?id=<?php echo $row['id'];?>">Tambah</a>
	</div>
