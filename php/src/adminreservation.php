			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item"><a class="nav-link" href="adminedit.php">edit</a></li>
						...
						<li class="nav-item active"><a class="nav-link" href="adminreservation.php">Reservation</a>
								...
								<div class="col-md-6">
									<h3>Book a table</h3>
										...
										<div class="form-group">
											<input type="text" class="form-control" id="name" name="name" placeholder="Reservation Date" required data-error="Please enter reservation date">
											<div class="help-block with-errors"></div>
										</div>                               
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" name="name" placeholder="Reservation Time" required data-error="Please enter reservation time">
											<div class="help-block with-errors"></div>
										</div>                               
									</div>
									<div class="col-md-12">
											...
											<div id="reviews" class="carousel slide" data-ride="carousel">
												<div class="carousel-inner mt-4">
													<div class="carousel-item text-center active">
														...
														<p class="m-0 pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, luctus dui. Mauris magna metus, dapibus nec turpis vel, semper malesuada ante. Idac bibendum scelerisque non non purus. Suspendisse varius nibh non aliquet.</p></div>
														</div>
													</div>
												</div>
											</div>
