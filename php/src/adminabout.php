			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="adminabout.php">About</a></li>
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="blog-box-inner">
						<div class="blog-img-box">
							<img class="img-fluid" src="images/irham.jpeg" alt="">
						</div>
						<div class="blog-detail" href="text-center">
							<h4>Irhan Izza</h4>
							<p>Class = TI-2B</p>
							<p>Absent = 16</p>
							<p>Study Program = D-IV Teknik Informatika<p>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-12">
					<div class="blog-box-inner">
						<div class="blog-img-box">
							<img class="img-fluid" src="images/nada.jpg" alt="">
						</div>
						<div class="blog-detail" href="text-center">
							<h4>Nada Alya K</h4>
							<p>Class = TI-2B</p>
